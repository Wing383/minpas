...
import '../pages-styles/BottomNav.css'
...
function BottomNav() {
  return (
    <nav className="bottom-nav" id="bottom-nav">
      ...
      <NavLink to="/timetable" className={({ isActive }) => `bottom-nav-item ${isActive ? 'bottom-nav-item--active' : ''}`}>
        <svg className="bottom-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <span className="bottom-nav-label">時間割</span>
      </NavLink>

      <NavLink to="/reviews" className={({ isActive }) => `bottom-nav-item ${isActive ? 'bottom-nav-item--active' : ''}`}>
        <svg className="bottom-nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>
          <line x1="8" y1="8" x2="16" y2="8"/>
          <line x1="8" y1="12" x2="13" y2="12"/>
        </svg>
        <span className="bottom-nav-label">口コミ</span>
      </NavLink>
